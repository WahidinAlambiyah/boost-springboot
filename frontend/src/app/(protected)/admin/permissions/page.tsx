...
export default function AdminPermissionsPage() {
  ...
  const deleteMutation = useMutation({ mutationFn: (id: string) => adminRbacService.deletePermission(id), onSuccess: async () => { setPendingDeletePermission(null); await invalidatePermissions(); } });
