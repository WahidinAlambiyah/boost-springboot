...
export default function AdminRolesPage() {
  ...
  const deleteMutation = useMutation({ mutationFn: (id: string) => adminRbacService.deleteRole(id), onSuccess: invalidateRoles });
