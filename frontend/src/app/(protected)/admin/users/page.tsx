...
export default function AdminUsersPage() {
  ...
  const toggleActiveMutation = useMutation({ mutationFn: ({ id, active }: { id: string; active: boolean }) => adminRbacService.updateUserActive(id, active), onSuccess: invalidateUsers });
  const deleteMutation = useMutation({ mutationFn: (id: string) => adminRbacService.deleteUser(id), onSuccess: invalidateUsers });
