...
import { footerContent, footerLinks, publicNavigationLabels, siteBrand, siteContact } from "@/content/public/site";
  ...
  return (
    <footer className="border-t border-zinc-200 bg-white">
      <div className="layout-container grid gap-10 py-12 sm:grid-cols-2 lg:grid-cols-3">
        ...
        <div>
          <p className="text-sm font-semibold uppercase tracking-wide text-zinc-500">{footerContent.importantLinksTitle}</p>
          <nav className="mt-3 grid gap-2" aria-label={publicNavigationLabels.footer}>
        ...
        <div className="sm:justify-self-end lg:justify-self-auto">
          <p className="text-sm font-semibold uppercase tracking-wide text-zinc-500">{footerContent.contactTitle}</p>
