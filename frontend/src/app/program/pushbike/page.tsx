  ...
  return (
    <PublicPageLayout>
      <section className="container mx-auto w-full px-6 py-16">
        <h1 className="text-3xl font-semibold text-zinc-900">{programDetailPageContent.pushbike.title}</h1>
        <p className="mt-4 max-w-3xl text-zinc-700">{programDetailPageContent.pushbike.description}</p>
        ...
        <section className="mt-12">
          <h2 className="text-2xl font-semibold text-zinc-900">{programDetailPageContent.pushbike.levelsTitle}</h2>
        ...
        <section className="mt-12">
          <h2 className="text-2xl font-semibold text-zinc-900">{programDetailPageContent.pushbike.skillsTitle}</h2>
        ...
        <section className="mt-12">
          <h2 className="text-2xl font-semibold text-zinc-900">{programDetailPageContent.pushbike.scheduleTitle}</h2>
        ...
        <section className="mt-12">
          <h2 className="text-2xl font-semibold text-zinc-900">{programDetailPageContent.pushbike.faqTitle}</h2>
        ...
        <div className="mt-12">
          <a
            href={programDetailPageContent.pushbike.ctaHref}
          ...
          >
            {programDetailPageContent.pushbike.ctaLabel}
          </a>
        </div>
      </section>
    </PublicPageLayout>
