...
export const programDetails: Record<ProgramSlug, ProgramDetail> = {
  ...
  "kelas-belajar": {
    ...
    notes: ["Materi dibagi berdasarkan kelompok usia", "Laporan progres dibagikan rutin ke orang tua"],
  },
};
...
export const pushbikeProgramContent = {
  ...
  benefits: ["Melatih keseimbangan tubuh", "Meningkatkan fokus & keberanian", "Membangun disiplin dan sportivitas"],
  assessedSkills: [
    "Balance",
    "Start Position",
    "Steering Control",
...
export const learningProgramContent = {
  classes: ["Fun English", "Basic Math", "Storytelling", "Focus Activity", "Creative Learning"],
  schedules: [
    "Senin & Rabu - 16.00 - 17.00 (Fun English & Storytelling)",
    "Selasa & Kamis - 16.00 - 17.00 (Basic Math & Focus Activity)",
    "Jumat - 15.30 - 16.30 (Creative Learning)",
  ],
} as const;
